...
import {height, numeroDuasCasas, width} from '../../utils/Utils';
...
import {Envolvedor, Entrada, Pressionavel} from './estilos';
...
const EntradaDeData: React.FC<iEntradaDeData> = ({
  ...
  return (
    <Envolvedor>
      <Entrada
        value={`${numeroDuasCasas(data.dia)}/${numeroDuasCasas(data.mes)}/${
          data.ano
        }`}
        editable={false}
        placeholder="DD/MM/YY"></Entrada>
...
export const DialogData: React.FC<iDialogData> = ({
  calendarioVisivel,
  setCalendarioVisivel,
  setDia,
  setData,
